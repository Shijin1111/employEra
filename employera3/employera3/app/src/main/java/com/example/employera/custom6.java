...
public class custom6 extends BaseAdapter{
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        TextView tv2=(TextView)gridView.findViewById(R.id.textView84);
        TextView tv3=(TextView)gridView.findViewById(R.id.textView85);
        TextView tv4=(TextView)gridView.findViewById(R.id.textView86);
        TextView tv5=(TextView)gridView.findViewById(R.id.textView87);
        TextView tv6=(TextView)gridView.findViewById(R.id.textView88);
